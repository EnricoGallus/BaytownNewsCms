...
ActiveRecord::Schema[7.1].define(version: 2024_01_27_012810) do
  ...
  create_table "publication_headers", force: :cascade do |t|
    t.bigint "publication_id", null: false
    t.string "content"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["publication_id"], name: "index_publication_headers_on_publication_id"
  end
  ...
  add_foreign_key "publication_headers", "publications"
end
